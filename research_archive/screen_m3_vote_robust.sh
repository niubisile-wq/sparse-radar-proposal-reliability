...
for seed in 2026 2027; do
  input="$root/results/m3_consensus_stage_${dataset}_seed${seed}.pkl"
  for iou in 0.22 0.24 0.25 0.26 0.28 0.30 0.35 0.40; do
    for strength in 0.35 0.40 0.45 0.50 0.60; do
      tag="m3vr_xy_iou${iou/./p}_s${strength/./p}"
