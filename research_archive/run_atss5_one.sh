...
cfg="$repo/tools/cfgs/astyx_models/pointpillars_atss_${dataset}_car.yaml"
tag="fair_atss5_${dataset}_seed${seed}_retry"
...
case "$dataset" in
    astyx)
        overrides=(--set MODEL.DENSE_HEAD.TARGET_ASSIGNER_CONFIG.TOPK 5
