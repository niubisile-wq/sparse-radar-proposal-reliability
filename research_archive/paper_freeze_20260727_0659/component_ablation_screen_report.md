...
- `pvd_rgpc` and `q55pvd_rgpc` demonstrate that adding RGPC on top of PVD can
  help some cells while hurting others.
...
| pvd_rgpc vs pvd | 34.4606 (+2.5193) | 12.6728 (-3.5067) | 46.3428 (+4.6305) | pending | partial |
